...
namespace LabTestOne.Migrations
{
    public partial class version_initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    createdAt = table.Column<DateTime>(nullable: true),
                    updatedAt = table.Column<DateTime>(nullable: true),
                    nameOfAsse = table.Column<string>(nullable: true),
                    nid = table.Column<string>(nullable: true),
                    utin = table.Column<string>(nullable: true),
                    tin = table.Column<string>(nullable: true),
                    circel = table.Column<string>(nullable: true),
                    taxZone = table.Column<string>(nullable: true),
                    asseYear = table.Column<string>(nullable: true),
                    isResident = table.Column<bool>(nullable: false),
                    familyStatus = table.Column<bool>(nullable: false),
                    nameOFEmployee = table.Column<string>(nullable: true),
                    husbandORWife = table.Column<string>(nullable: true),
                    ...
                    prmanentAddress = table.Column<string>(nullable: true),
